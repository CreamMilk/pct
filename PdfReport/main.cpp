...
int main(int argc, char *argv[])
{
	...
	//ExportPdf(QString::fromLocal8Bit("C:/Users/Administrator/Desktop/JiNingPro/pdf/x64/Debug/testdata/00/检测结果.html"),
	//QString::fromLocal8Bit("C:/Users/Administrator/Desktop/JiNingPro/pdf/x64/Debug/testdata/00/检测结果test.pdf"));
...
void GenerateHtml(QString json_path, QString html_path)
{
	...
	// utf8格式的
	QFile inputFile(QCoreApplication::applicationDirPath() + QStringLiteral("/../../../PdfReport/Resources/template.html"));
